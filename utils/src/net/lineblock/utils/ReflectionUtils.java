...
public final class ReflectionUtils {
	...
	private ReflectionUtils() {
	  ...
	  public enum PackageType {
	    MINECRAFT_SERVER("net.minecraft.server." + getServerVersion(), null),
	    CRAFTBUKKIT("org.bukkit.craftbukkit." + getServerVersion(), null),
	    BUKKIT("org.bukkit", null),
	    ...
	    PackageType(String string2, String string) {
	    	this.path = string2;
	    }
	  ...
	  public enum DataType {
	    ...
	    DataType(Class<?> class1, Class<?> reference) {
	      this.primitive = class1;
